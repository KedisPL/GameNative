...
public class NavigationDialog extends ContentDialog {
    ...
    public static final int ACTION_RELATIVE_MOUSE = 6;
    public static final int ACTION_TASK_MANAGER = 7;
    ...
    public NavigationDialog(@NonNull Context context, NavigationListener listener) {
        ...
        addMenuItem(context, grid, R.drawable.icon_mouse, R.string.relative_mouse_movement, ACTION_RELATIVE_MOUSE, listener, 1.0f);
